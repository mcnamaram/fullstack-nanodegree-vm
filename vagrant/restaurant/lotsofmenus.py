...
menuItem2 = MenuItem(
    ...
    since the imperial era. The meat is prized for its thin, crisp skin, with \
    authentic versions of the dish serving mostly the skin and little meat, \
...
menuItem3 = MenuItem(
    ...
    description="Seared rare ahi, avocado, edamame, cucumber with wasabi soy \
    sauce ",
...
menuItem5 = MenuItem(
    ...
    description="A Chinese noodle soup made of stewed or red braised beef, beef \
    broth, vegetables and Chinese noodles.",
...
menuItem6 = MenuItem(
    ...
    wheat noodles served in a meat- or (occasionally) fish-based broth, often \
    flavored with soy sauce or miso, and uses toppings such as sliced pork, \
...
menuItem1 = MenuItem(
    name="Pho",
    description="a Vietnamese noodle soup consisting of broth, linguine-shaped \
    rice noodles called banh pho, a few herbs, and meat.",
...
menuItem2 = MenuItem(
    ...
    meat and finely chopped vegetables wrapped into a piece of dough skin. The\
    skin can be either thin and elastic or thicker.",
...
menuItem3 = MenuItem(
    name="Gyoza",
    description="The most prominent differences between Japanese-style \
    gyoza and Chinese-style jiaozi are the rich garlic flavor, which is less \
    noticeable in the Chinese version, the light seasoning of Japanese \
    gyoza with salt and soy sauce, and the fact that gyoza wrappers are much \
    thinner",
...
menuItem4 = MenuItem(
    name="Stinky Tofu",
    description="Taiwanese dish, deep fried fermented tofu served with pickled \
    cabbage.",
...
menuItem3 = MenuItem(
    ...
    jelly, caramel, cream, and freshly made mochi",
...
menuItem4 = MenuItem(
    ...
    description="Golden fried cauliflower florets in a midly spiced soya,garlic \
    sauce cooked with fresh cilantro, celery, chilies,ginger & green onions",
...
menuItem5 = MenuItem(
    ...
    curry sauce, potatoes (aloo), fried cauliflower (gobi) and chutney. \
    Nom Nom",
...
menuItem1 = MenuItem(
    ...
    description="Lobster, shrimp, sea snails, crawfish, stacked into a \
    delicious tower",
...
menuItem5 = MenuItem(
    name="Tonkatsu Ramen",
    description="Noodles in a delicious pork-based broth with a soft-boiled \
    egg",
    price="$7.95", course="Entree", restaurant=restaurant1)
...
menuItem1 = MenuItem(
    name="Lamb Curry",
    description="Slow cook that thang in a pool of tomatoes, onions and alllll \
...
menuItem2 = MenuItem(
    name="Broiled salmon",
    description="Salmon fillet marinated with fresh herbs and broiled hot & \
    fast",
...
menuItem3 = MenuItem(
    ...
    description="Wild morel mushrooms fried in butter, served on herbed toast \
    slices",
...
menuItem4 = MenuItem(
    ...
    description="Chicken marinated in yoghurt and seasoned with a spicy \
    mix(chilli, tamarind among others) and slow cooked in a cylindrical clay \
...
menuItem2 = MenuItem(
    name="Cachapa",
    description="Golden brown, corn-based Venezuelan pancake; usually stuffed \
    with queso telita or queso de mano, and possibly lechon. ",
    price="$7.99", course="Entree", restaurant=restaurant1)
...
menuItem1 = MenuItem(
    ...
    description="Crispy Toast with Sesame Seeds slathered with buttery \
...
menuItem1 = MenuItem(
    ...
    description="Japanese egg custard served hot with spicey Italian Pork Jowl \
    (guanciale)",
